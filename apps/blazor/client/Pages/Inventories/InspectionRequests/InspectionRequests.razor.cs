...
using MudBlazor;
using AMIS.Blazor.Client.Pages.Inventories.Inspections; // for InspectionDialog
using System.Linq;
using Shared.Authorization; // ensure LINQ

namespace AMIS.Blazor.Client.Pages.Inventories.InspectionRequests;
...
public partial class InspectionRequests
{
    ...
    private async Task OnInspect(InspectionRequestResponse item)
    {
        ...
        var parameters = new DialogParameters
        {
            { nameof(AMIS.Blazor.Client.Pages.Inventories.Inspections.InspectionDialog.Model), model },
            { nameof(AMIS.Blazor.Client.Pages.Inventories.Inspections.InspectionDialog.IsCreate), true },
            { nameof(AMIS.Blazor.Client.Pages.Inventories.Inspections.InspectionDialog.InspectionRequests), requestList },
            { nameof(AMIS.Blazor.Client.Pages.Inventories.Inspections.InspectionDialog.Employees), _employees }
        };
        var options = new DialogOptions { CloseButton = true, MaxWidth = MaxWidth.Medium, FullWidth = true };
