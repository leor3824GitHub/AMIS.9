...
internal sealed class ProcurementProjectConfiguration : IEntityTypeConfiguration<ProcurementProject>
{
    public void Configure(EntityTypeBuilder<ProcurementProject> builder)
    {
        ...
        builder.ToTable("ProcurementProjects", SchemaNames.Inventories);
        ...
        {
            schedule.ToTable("ProcurementSchedules", SchemaNames.Inventories);
        ...
        {
            budget.ToTable("ProjectBudgets", SchemaNames.Inventories);
