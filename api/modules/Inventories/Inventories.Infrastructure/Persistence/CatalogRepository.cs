...
internal sealed class InventoriesRepository<T> : RepositoryBase<T>, IReadRepository<T>, IRepository<T>
    where T : class, IAggregateRoot
{
    public InventoriesRepository(InventoriesDbContext context)
        : base(context)
    {
    }
