...
/// <summary>
/// Represents an audit log entry for inventory transactions
/// Tracks all changes to inventory for compliance and reconciliation purposes
/// </summary>
public class InventoryTransactionLog : AuditableEntity, IAggregateRoot
{
    /// <summary>
    /// Property code of the item being transacted
    /// </summary>
    public string PropertyCode { get; private set; } = string.Empty;

    /// <summary>
    /// Type of transaction (PPERR for receiving, PPEIR for issuance)
    /// </summary>
    ...
    /// </summary>
    public static InventoryTransactionLog CreateSuccess(
        string propertyCode,
        ...
        string? correlationId = null)
    {
        ...
        return new InventoryTransactionLog
        {
    ...
    /// </summary>
    public static InventoryTransactionLog CreateFailure(
        string propertyCode,
        string transactionType,
        string reportNumber,
        int inventoryBefore,
    ...
    public string GetSummary() => Success
        ? $"{TransactionType} | {PropertyCode} | Change: {QuantityChange:+#;-#;0} | Before: {InventoryBefore} → After: {InventoryAfter} | Ref: {ReportNumber}"
        : $"{TransactionType} | {PropertyCode} | FAILED | Error: {ErrorMessage} | Ref: {ReportNumber}";

    /// <summary>
    /// Checks if this is a receiving transaction
    /// </summary>
    public bool IsReceiving() => TransactionType == "PPERR";

    /// <summary>
    /// Checks if this is an issuance transaction
    /// </summary>
    public bool IsIssuance() => TransactionType == "PPEIR";
}
