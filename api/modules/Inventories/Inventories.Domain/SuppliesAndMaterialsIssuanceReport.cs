...
/// </summary>
public class SuppliesAndMaterialsIssuanceReport : AuditableEntity, IAggregateRoot
{
    // Transaction Header
        ...
        string? notes = null)
    {
        ...
        ArgumentNullException.ThrowIfNull(smirNumber);
        ArgumentNullException.ThrowIfNull(recipient);
        ArgumentNullException.ThrowIfNull(issuanceReason);
