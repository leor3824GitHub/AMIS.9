...
public sealed class UpdateIssuanceItemHandler(
    ...
    [FromKeyedServices("inventories:issuanceItems")] IRepository<IssuanceItem> repository,
    [FromKeyedServices("inventories:inventories")] IRepository<Inventory> inventoryRepository,
    [FromKeyedServices("inventories:issuances")] IRepository<Issuance> issuanceRepository)
