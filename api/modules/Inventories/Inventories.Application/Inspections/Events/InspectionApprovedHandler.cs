...
public sealed class InspectionApprovedHandler : INotificationHandler<InspectionApproved>
{
    ...
    public InspectionApprovedHandler(
        ...
        [FromKeyedServices("inventories:inspectionRequests")] IRepository<InspectionRequest> inspectionRequestRepo,
        [FromKeyedServices("inventories:purchases")] IRepository<Purchase> purchaseRepo,
        [FromKeyedServices("inventories:inventories")] IRepository<Inventory> inventoryRepo,
        [FromKeyedServices("inventories:inventory-transactions")] IRepository<InventoryTransaction> inventoryTxnRepo,
    ...
    public async Task Handle(InspectionApproved notification, CancellationToken cancellationToken)
    {
        ...
        var requestSpec = new AMIS.WebApi.Inventories.Application.InspectionRequests.Specifications.GetInspectionRequestByPurchaseSpec(notification.PurchaseId.Value);
