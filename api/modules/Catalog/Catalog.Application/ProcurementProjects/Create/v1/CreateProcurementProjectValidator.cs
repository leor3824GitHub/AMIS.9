...
public sealed class CreateProcurementProjectValidator : AbstractValidator<CreateProcurementProjectCommand>
{
    public CreateProcurementProjectValidator()
    {
        ...
        RuleFor(x => x)
            .Must(x => x.TotalAmount == x.MooeAmount + x.CoAmount || (x.TotalAmount == 0 && x.MooeAmount == 0 && x.CoAmount == 0))
