...
namespace AMIS.WebApi.Migrations.PostgreSQL.Catalog
{
    ...
    [Migration("20251117024103_Catalog_Employee_ContactInfo")]
    partial class Catalog_Employee_ContactInfo
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AMIS.WebApi.Catalog.Domain.Employee", b =>
                {
                    b.OwnsOne("AMIS.WebApi.Catalog.Domain.ValueObjects.ContactInformation", "ContactInfo", b1 =>
                        {
                            ...
                            b1.ToTable("Employees", "catalog");

                            b1.WithOwner()
                                .HasForeignKey("EmployeeId");
                        });

                    b.OwnsOne("AMIS.WebApi.Catalog.Domain.ValueObjects.ResponsibilityCode", "ResponsibilityCode", b1 =>
                        {
                            b1.Property<Guid>("EmployeeId")
                                .HasColumnType("uuid");
                    ...
                    b.Navigation("ResponsibilityCode")
                        .IsRequired();
                });
